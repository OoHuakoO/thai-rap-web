...
export const top20Stores: Top20Item[] = [
  ...
  { rank: 3,  id: 's03', name: 'ห้องอาหารลพบุรี',         province: 'ลพบุรี',  type: 'อาหารพื้นบ้าน', score: 83 },
  ...
  { rank: 6,  id: 's06', name: 'ร้านข้าวต้มสระบุรี',      province: 'สระบุรี',  type: 'อาหารจานด่วน', score: 77 },
  { rank: 7,  id: 's07', name: 'ครัวเรือนไทย',           province: 'ลพบุรี',  type: 'อาหารพื้นบ้าน', score: 76 },
  ...
  { rank: 10, id: 's10', name: 'ร้านกาแฟและอาหารว่าง',    province: 'อ่างทอง', type: 'เบเกอรี่',      score: 71 },
  { rank: 11, id: 's11', name: 'ครัวคุณแม่',              province: 'สระบุรี',  type: 'อาหารไทย',     score: 70 },
  { rank: 12, id: 's12', name: 'อาหารทะเลลพบุรี',        province: 'ลพบุรี',  type: 'อาหารทะเล',    score: 69 },
  { rank: 13, id: 's13', name: 'สวนอาหารชัยนาท',         province: 'ชัยนาท',  type: 'อาหารไทย',     score: 68 },
  { rank: 14, id: 's14', name: 'ข้าวหมูแดงอ่างทอง',      province: 'อ่างทอง', type: 'อาหารจานด่วน', score: 67 },
  { rank: 15, id: 's15', name: 'ร้านผัดไทยสิงห์บุรี',    province: 'สิงห์บุรี', type: 'อาหารไทย',   score: 65 },
  { rank: 16, id: 's16', name: 'ก๋วยเตี๋ยวเรือสระบุรี',   province: 'สระบุรี',  type: 'อาหารจานด่วน', score: 64 },
  { rank: 17, id: 's17', name: 'ครัวลาวลพบุรี',           province: 'ลพบุรี',  type: 'อาหารพื้นบ้าน', score: 63 },
  { rank: 18, id: 's18', name: 'บ้านข้าวหลาม',           province: 'สิงห์บุรี', type: 'ขนมไทย',      score: 61 },
  { rank: 19, id: 's19', name: 'ร้านน้ำเต้าหู้ชัยนาท',   province: 'ชัยนาท',  type: 'เครื่องดื่ม',    score: 58 },
  { rank: 20, id: 's20', name: 'อาหารปิ้งย่างสระบุรี',    province: 'สระบุรี',  type: 'อาหารปิ้งย่าง', score: 55 },
]
...
export const reportsStatus: ReportStatusItem[] = [
  ...
  { id: 'r2', name: 'รายงาน T1 สระบุรี',   type: 'รายจังหวัด',  status: 'pass',    updatedAt: '2568-05-20' },
  { id: 'r3', name: 'รายงาน T1 ลพบุรี',    type: 'รายจังหวัด',  status: 'pending', updatedAt: '2568-05-28' },
  { id: 'r4', name: 'แผน Action T2',        type: 'แผนงาน',      status: 'pending', updatedAt: '2568-05-28' },
  { id: 'r5', name: 'รายงาน Red Flag',      type: 'แจ้งเตือน',   status: 'warning', updatedAt: '2568-05-25' },
]
