...
export const colors = {
  ...
  purpleBanner: '#7A51A0', // secondary badges, project banner heading text (matches design)
  blue: '#2563EB', // 4th chart series — same value as the `blue-600` analytics accent
...
// Categorical palette for province distribution charts/legends — cycled by
// index, distinct from chartColors (which is ordered by series priority).
export const provinceChartColors = [
  '#F17128', // = colors.orange
  '#7B1FA2',
  '#1976D2',
  '#4CAF50',
  '#9E9E9E',
