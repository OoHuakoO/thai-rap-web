...
> = {
  info: {
    icon: Info,
    className: 'border-blue-200 bg-blue-50 [&>svg]:text-blue-500',
    iconClass: 'text-blue-500',
  },
  warning: {
    icon: AlertTriangle,
    className: 'border-amber-200 bg-amber-50 [&>svg]:text-amber-500',
    iconClass: 'text-amber-500',
  },
  success: {
    icon: CheckCircle,
    className: 'border-score-green/20 bg-score-green/10 [&>svg]:text-score-green',
    iconClass: 'text-score-green',
  },
  error: {
    icon: XCircle,
    className: 'border-score-red/20 bg-score-red/10 [&>svg]:text-score-red',
