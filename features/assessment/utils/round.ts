...
export function isRoundCompleted(
  ...
  return isCompletedStatus(summaries?.find((s) => s.round === round)?.status);
}
 ...
 */
export function getLatestCompletedRound(summaries: AssessmentSummary[] | undefined): Round | null {
